                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($data as $user)
                                    <tr class="user-row">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap name">{{ $user->tgl_bayar }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap name">{{ $user->jumlah_bayar }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap username">{{ $user->metode_pembayaran }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap name">{{ $user->keterangan }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap username">{{ $user->user->name }}</td>
                                    ...
                                    <x-modal name="confirm-delete-{{ $user->id }}" :show="false" maxWidth="sm">
                                        <div class="p-6">
                                            ...
                                            <p class="mt-2 text-sm text-gray-600">Apakah Anda yakin ingin menghapus Pembayaran<b> dengan NIS {{ $user->nis }}</b>?</p>
