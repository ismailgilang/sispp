<x-app-layout>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{$siswa}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900">{{$kelas}}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-gray-500">SPP Yang Belum Dibayarkan {{$bulanSekarang}} {{$tahunSekarang}}</h3>
                            <p class="text-2xl font-semibold text-gray-900">Rp {{ number_format($totalBelum, 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-gray-500">Spp Masuk {{$bulanSekarang}} {{$tahunSekarang}}</h3>
                            <p class="text-2xl font-semibold text-gray-900">Rp {{ number_format($totalLunas, 0, ',', '.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start pb-4 border-b border-gray-200">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500">{{ $siswa }} Siswa & Siswi</p>
                            </div>
                        </div>
                        <div class="flex items-start pb-4 border-b border-gray-200">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500">{{ $siswaSekarang }} Siswa terdaftar siswa</p>
                            </div>
                        </div>
                        <div class="flex items-start pb-4 border-b border-gray-200">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500">{{ $sppbelum }} Siswa</p>
                            </div>
                        </div>
                        <div class="flex items-start pb-4">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-sm text-gray-500">{{ $spplunas }} Siswa terdaftar siswa</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a href="{{ route('Siswa.index') }}" class="p-4 rounded-lg bg-blue-50 hover:bg-blue-100 text-center transition-colors">
                        ...
                        <a href="{{ route('Users.index') }}" class="p-4 rounded-lg bg-sky-50 hover:bg-sky-100 text-center transition-colors">
                        ...
                        <a href="{{ route('Jurusan.index') }}" class="p-4 rounded-lg bg-green-50 hover:bg-green-100 text-center transition-colors">
                        ...
                        <a href="{{ route('Kelas.index') }}" class="p-4 rounded-lg bg-yellow-50 hover:bg-yellow-100 text-center transition-colors">
                        ...
                        <a href="{{ route('Pembayaran.index') }}" class="p-4 rounded-lg bg-purple-50 hover:bg-purple-100 text-center transition-colors">
                        ...
                        <a href="{{ route('Spp.index') }}" class="p-4 rounded-lg bg-red-50 hover:bg-red-100 text-center transition-colors">
    ...
    @if (Auth::user()->role === 'siswa')
         <div class="py-6 px-4 sm:px-6 lg:px-8 w-full">
            <!-- Header Welcome -->
            <div class="mb-8 w-full flex flex-col justify-center items-center">
                <h1 class="text-2xl font-bold text-gray-900">Selamat Datang, <span class="text-blue-600">{{ Auth::user()->name }}</span></h1>
                <p class="mt-1 text-gray-600">Akses cepat ke semua fitur SISPP</p>
            </div>
         </div>
